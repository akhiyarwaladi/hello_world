...
try:
    ...
    # Load model
    model = YOLO("results/current_experiments/training/detection/yolo12_detection/multi_pipeline_20250920_131500_yolo12_det/weights/best.pt")
    print(f"📦 Loaded model: YOLO12")
    ...
    # Save results
    output_file = Path("experiments_organized_20250920_143749/yolo12_complete/04_analysis/iou_variation") / "iou_variation_results.json"
    ...
    csv_file = Path("experiments_organized_20250920_143749/yolo12_complete/04_analysis/iou_variation") / "iou_comparison_table.csv"
...
"""
    ...
    md_file = Path("experiments_organized_20250920_143749/yolo12_complete/04_analysis/iou_variation") / "iou_analysis_report.md"
    with open(md_file, 'w') as f:
        f.write(md_content)

    print(f"\n✅ IoU variation analysis completed!")
    print(f"📁 Results saved to: {Path('experiments_organized_20250920_143749/yolo12_complete/04_analysis/iou_variation')}")
