...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.000 | 0.000 | 0.000 | 0.000 | training_validation |
| 0.75 | 0.000 | 0.000 | 0.000 | 0.000 | estimated_from_training |
| 0.5:0.95 | 0.000 | 0.000 | 0.000 | 0.000 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 1.0):
- **mAP@0.5**: 0.000000 (training validation)
- **mAP@0.75**: 0.000000 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.000000 (training validation)
...
- **Best Epoch**: 1.0 out of 5 total epochs
