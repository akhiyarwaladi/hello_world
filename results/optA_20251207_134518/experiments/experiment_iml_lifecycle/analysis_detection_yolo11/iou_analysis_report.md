...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.839 | 0.485 | 0.844 | 0.784 | training_validation |
| 0.75 | 0.582 | 0.485 | 0.844 | 0.784 | estimated_from_training |
| 0.5:0.95 | 0.485 | 0.485 | 0.844 | 0.784 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 5.0):
- **mAP@0.5**: 0.838690 (training validation)
- **mAP@0.75**: 0.581928 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.484940 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.839, mAP@0.75=0.582, mAP@0.5:0.95=0.485
- **Best Epoch**: 5.0 out of 5 total epochs
