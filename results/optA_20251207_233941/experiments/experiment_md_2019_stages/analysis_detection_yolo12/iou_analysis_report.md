...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.935 | 0.775 | 0.878 | 0.842 | training_validation |
| 0.75 | 0.930 | 0.775 | 0.878 | 0.842 | estimated_from_training |
| 0.5:0.95 | 0.775 | 0.775 | 0.878 | 0.842 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 64.0):
- **mAP@0.5**: 0.934590 (training validation)
- **mAP@0.75**: 0.930468 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.775390 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.935, mAP@0.75=0.930, mAP@0.5:0.95=0.775
- **Best Epoch**: 64.0 out of 100 total epochs
