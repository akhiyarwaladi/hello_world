...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.957 | 0.627 | 0.944 | 0.896 | training_validation |
| 0.75 | 0.753 | 0.627 | 0.944 | 0.896 | estimated_from_training |
| 0.5:0.95 | 0.627 | 0.627 | 0.944 | 0.896 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 84.0):
- **mAP@0.5**: 0.956910 (training validation)
- **mAP@0.75**: 0.752940 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.627450 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.957, mAP@0.75=0.753, mAP@0.5:0.95=0.627
