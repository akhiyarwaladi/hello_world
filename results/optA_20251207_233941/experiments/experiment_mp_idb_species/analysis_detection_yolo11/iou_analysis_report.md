...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.966 | 0.637 | 0.901 | 0.953 | training_validation |
| 0.75 | 0.765 | 0.637 | 0.901 | 0.953 | estimated_from_training |
| 0.5:0.95 | 0.637 | 0.637 | 0.901 | 0.953 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 86.0):
- **mAP@0.5**: 0.965580 (training validation)
- **mAP@0.75**: 0.764832 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.637360 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.966, mAP@0.75=0.765, mAP@0.5:0.95=0.637
