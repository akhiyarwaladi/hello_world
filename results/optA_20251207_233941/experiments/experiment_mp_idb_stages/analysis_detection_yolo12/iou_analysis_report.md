...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.956 | 0.589 | 0.922 | 0.914 | training_validation |
| 0.75 | 0.707 | 0.589 | 0.922 | 0.914 | estimated_from_training |
| 0.5:0.95 | 0.589 | 0.589 | 0.922 | 0.914 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 95.0):
- **mAP@0.5**: 0.956240 (training validation)
- **mAP@0.75**: 0.706896 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.589080 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.956, mAP@0.75=0.707, mAP@0.5:0.95=0.589
- **Best Epoch**: 95.0 out of 100 total epochs
