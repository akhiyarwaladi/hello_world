...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.968 | 0.782 | 0.932 | 0.900 | training_validation |
| 0.75 | 0.939 | 0.782 | 0.932 | 0.900 | estimated_from_training |
| 0.5:0.95 | 0.782 | 0.782 | 0.932 | 0.900 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 86.0):
- **mAP@0.5**: 0.968340 (training validation)
- **mAP@0.75**: 0.938748 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.782290 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.968, mAP@0.75=0.939, mAP@0.5:0.95=0.782
