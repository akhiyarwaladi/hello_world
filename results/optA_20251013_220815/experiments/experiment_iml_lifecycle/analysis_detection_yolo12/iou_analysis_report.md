...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.953 | 0.720 | 0.871 | 0.978 | training_validation |
| 0.75 | 0.864 | 0.720 | 0.871 | 0.978 | estimated_from_training |
| 0.5:0.95 | 0.720 | 0.720 | 0.871 | 0.978 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 67.0):
- **mAP@0.5**: 0.952940 (training validation)
- **mAP@0.75**: 0.864024 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.720020 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.953, mAP@0.75=0.864, mAP@0.5:0.95=0.720
