...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.758 | 0.544 | 0.703 | 0.698 | training_validation |
| 0.75 | 0.653 | 0.544 | 0.703 | 0.698 | estimated_from_training |
| 0.5:0.95 | 0.544 | 0.544 | 0.703 | 0.698 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 41.0):
- **mAP@0.5**: 0.758310 (training validation)
- **mAP@0.75**: 0.652956 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.544130 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.758, mAP@0.75=0.653, mAP@0.5:0.95=0.544
- **Best Epoch**: 41.0 out of 100 total epochs
