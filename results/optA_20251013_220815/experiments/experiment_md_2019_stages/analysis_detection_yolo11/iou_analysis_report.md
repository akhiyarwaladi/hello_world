...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.741 | 0.537 | 0.682 | 0.717 | training_validation |
| 0.75 | 0.645 | 0.537 | 0.682 | 0.717 | estimated_from_training |
| 0.5:0.95 | 0.537 | 0.537 | 0.682 | 0.717 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 27.0):
- **mAP@0.5**: 0.740680 (training validation)
- **mAP@0.75**: 0.644916 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.537430 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.741, mAP@0.75=0.645, mAP@0.5:0.95=0.537
- **Best Epoch**: 27.0 out of 100 total epochs
