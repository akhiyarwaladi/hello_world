...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.924 | 0.623 | 0.860 | 0.909 | training_validation |
| 0.75 | 0.747 | 0.623 | 0.860 | 0.909 | estimated_from_training |
| 0.5:0.95 | 0.623 | 0.623 | 0.860 | 0.909 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 100.0):
- **mAP@0.5**: 0.924350 (training validation)
- **mAP@0.75**: 0.747276 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.622730 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.924, mAP@0.75=0.747, mAP@0.5:0.95=0.623
