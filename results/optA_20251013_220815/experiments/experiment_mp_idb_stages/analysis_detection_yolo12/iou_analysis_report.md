...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.952 | 0.595 | 0.952 | 0.845 | training_validation |
| 0.75 | 0.714 | 0.595 | 0.952 | 0.845 | estimated_from_training |
| 0.5:0.95 | 0.595 | 0.595 | 0.952 | 0.845 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 100.0):
- **mAP@0.5**: 0.951630 (training validation)
- **mAP@0.75**: 0.713532 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.594610 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.952, mAP@0.75=0.714, mAP@0.5:0.95=0.595
