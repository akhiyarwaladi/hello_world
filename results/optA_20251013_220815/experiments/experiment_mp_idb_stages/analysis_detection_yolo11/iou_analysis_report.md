...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.939 | 0.599 | 0.920 | 0.909 | training_validation |
| 0.75 | 0.718 | 0.599 | 0.920 | 0.909 | estimated_from_training |
| 0.5:0.95 | 0.599 | 0.599 | 0.920 | 0.909 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 99.0):
- **mAP@0.5**: 0.938650 (training validation)
- **mAP@0.75**: 0.718452 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.598710 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.939, mAP@0.75=0.718, mAP@0.5:0.95=0.599
- **Best Epoch**: 99.0 out of 100 total epochs
