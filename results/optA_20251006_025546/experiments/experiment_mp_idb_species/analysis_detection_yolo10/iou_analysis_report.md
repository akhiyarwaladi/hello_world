...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.935 | 0.581 | 0.913 | 0.895 | training_validation |
| 0.75 | 0.697 | 0.581 | 0.913 | 0.895 | estimated_from_training |
| 0.5:0.95 | 0.581 | 0.581 | 0.913 | 0.895 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 96.0):
- **mAP@0.5**: 0.934740 (training validation)
- **mAP@0.75**: 0.697296 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.581080 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.935, mAP@0.75=0.697, mAP@0.5:0.95=0.581
