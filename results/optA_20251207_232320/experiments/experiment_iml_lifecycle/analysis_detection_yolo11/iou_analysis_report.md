...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.840 | 0.528 | 0.804 | 0.804 | training_validation |
| 0.75 | 0.634 | 0.528 | 0.804 | 0.804 | estimated_from_training |
| 0.5:0.95 | 0.528 | 0.528 | 0.804 | 0.804 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 5.0):
- **mAP@0.5**: 0.840170 (training validation)
- **mAP@0.75**: 0.634164 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.528470 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.840, mAP@0.75=0.634, mAP@0.5:0.95=0.528
