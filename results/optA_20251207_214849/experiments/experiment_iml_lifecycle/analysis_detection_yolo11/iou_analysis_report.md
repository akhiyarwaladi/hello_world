...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.966 | 0.732 | 0.862 | 0.959 | training_validation |
| 0.75 | 0.878 | 0.732 | 0.862 | 0.959 | estimated_from_training |
| 0.5:0.95 | 0.732 | 0.732 | 0.862 | 0.959 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 18.0):
- **mAP@0.5**: 0.966130 (training validation)
- **mAP@0.75**: 0.878292 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.731910 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.966, mAP@0.75=0.878, mAP@0.5:0.95=0.732
- **Best Epoch**: 18.0 out of 100 total epochs
