...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.940 | 0.578 | 0.912 | 0.893 | training_validation |
| 0.75 | 0.694 | 0.578 | 0.912 | 0.893 | estimated_from_training |
| 0.5:0.95 | 0.578 | 0.578 | 0.912 | 0.893 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 76.0):
- **mAP@0.5**: 0.939830 (training validation)
- **mAP@0.75**: 0.693756 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.578130 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.940, mAP@0.75=0.694, mAP@0.5:0.95=0.578
- **Best Epoch**: 76.0 out of 100 total epochs
