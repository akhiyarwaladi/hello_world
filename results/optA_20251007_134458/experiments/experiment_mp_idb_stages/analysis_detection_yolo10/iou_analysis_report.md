...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.930 | 0.549 | 0.881 | 0.890 | training_validation |
| 0.75 | 0.658 | 0.549 | 0.881 | 0.890 | estimated_from_training |
| 0.5:0.95 | 0.549 | 0.549 | 0.881 | 0.890 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 92.0):
- **mAP@0.5**: 0.930490 (training validation)
- **mAP@0.75**: 0.658464 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.548720 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.930, mAP@0.75=0.658, mAP@0.5:0.95=0.549
- **Best Epoch**: 92.0 out of 100 total epochs
