...
|-------|--------|-----------|-----------|--------|
| YOLO10 | 0.9381 | 0.7771 | 0.9022 | 0.9222 |
| YOLO11 | 0.9499 | 0.7776 | 0.9191 | 0.9111 |
| YOLO12 | 0.9440 | 0.7821 | 0.9220 | 0.8667 |

### MD_2019_STAGES

| Model | mAP@50 | mAP@50-95 | Precision | Recall |
|-------|--------|-----------|-----------|--------|
| YOLO10 | 0.7084 | 0.5705 | 0.6789 | 0.7105 |
| YOLO11 | 0.7291 | 0.5771 | 0.6858 | 0.7570 |
| YOLO12 | 0.7112 | 0.5693 | 0.6592 | 0.7518 |

### MP_IDB_SPECIES

| Model | mAP@50 | mAP@50-95 | Precision | Recall |
|-------|--------|-----------|-----------|--------|
| YOLO10 | 0.9244 | 0.6012 | 0.8567 | 0.9073 |
| YOLO11 | 0.9257 | 0.6217 | 0.8652 | 0.9188 |
| YOLO12 | 0.9272 | 0.6225 | 0.8899 | 0.8928 |

### MP_IDB_STAGES

| Model | mAP@50 | mAP@50-95 | Precision | Recall |
|-------|--------|-----------|-----------|--------|
| YOLO10 | 0.9378 | 0.4448 | 0.9157 | 0.9312 |
| YOLO11 | 0.9448 | 0.6034 | 0.9315 | 0.8836 |
