...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.749 | 0.548 | 0.610 | 0.773 | training_validation |
| 0.75 | 0.658 | 0.548 | 0.610 | 0.773 | estimated_from_training |
| 0.5:0.95 | 0.548 | 0.548 | 0.610 | 0.773 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 27.0):
- **mAP@0.5**: 0.749110 (training validation)
- **mAP@0.75**: 0.657864 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.548220 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.749, mAP@0.75=0.658, mAP@0.5:0.95=0.548
