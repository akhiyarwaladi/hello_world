...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.937 | 0.623 | 0.885 | 0.907 | training_validation |
| 0.75 | 0.747 | 0.623 | 0.885 | 0.907 | estimated_from_training |
| 0.5:0.95 | 0.623 | 0.623 | 0.885 | 0.907 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 89.0):
- **mAP@0.5**: 0.936590 (training validation)
- **mAP@0.75**: 0.747468 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.622890 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.937, mAP@0.75=0.747, mAP@0.5:0.95=0.623
- **Best Epoch**: 89.0 out of 100 total epochs
