...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.928 | 0.593 | 0.861 | 0.899 | training_validation |
| 0.75 | 0.712 | 0.593 | 0.861 | 0.899 | estimated_from_training |
| 0.5:0.95 | 0.593 | 0.593 | 0.861 | 0.899 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 93.0):
- **mAP@0.5**: 0.927680 (training validation)
- **mAP@0.75**: 0.712020 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.593350 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.928, mAP@0.75=0.712, mAP@0.5:0.95=0.593
- **Best Epoch**: 93.0 out of 100 total epochs
