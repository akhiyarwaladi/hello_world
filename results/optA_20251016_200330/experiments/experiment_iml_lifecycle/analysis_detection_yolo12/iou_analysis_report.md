...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.965 | 0.673 | 0.890 | 0.889 | training_validation |
| 0.75 | 0.808 | 0.673 | 0.890 | 0.889 | estimated_from_training |
| 0.5:0.95 | 0.673 | 0.673 | 0.890 | 0.889 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 43.0):
- **mAP@0.5**: 0.964680 (training validation)
- **mAP@0.75**: 0.808032 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.673360 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.965, mAP@0.75=0.808, mAP@0.5:0.95=0.673
- **Best Epoch**: 43.0 out of 100 total epochs
