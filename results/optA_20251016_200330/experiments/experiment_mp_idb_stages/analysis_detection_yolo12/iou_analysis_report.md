...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.963 | 0.615 | 0.929 | 0.926 | training_validation |
| 0.75 | 0.738 | 0.615 | 0.929 | 0.926 | estimated_from_training |
| 0.5:0.95 | 0.615 | 0.615 | 0.929 | 0.926 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 100.0):
- **mAP@0.5**: 0.962750 (training validation)
- **mAP@0.75**: 0.738348 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.615290 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.963, mAP@0.75=0.738, mAP@0.5:0.95=0.615
