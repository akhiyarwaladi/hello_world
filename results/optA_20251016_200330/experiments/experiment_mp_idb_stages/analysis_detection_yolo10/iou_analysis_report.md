...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.960 | 0.549 | 0.950 | 0.905 | training_validation |
| 0.75 | 0.659 | 0.549 | 0.950 | 0.905 | estimated_from_training |
| 0.5:0.95 | 0.549 | 0.549 | 0.950 | 0.905 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 53.0):
- **mAP@0.5**: 0.960010 (training validation)
- **mAP@0.75**: 0.659208 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.549340 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.960, mAP@0.75=0.659, mAP@0.5:0.95=0.549
- **Best Epoch**: 53.0 out of 100 total epochs
