...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.780 | 0.570 | 0.684 | 0.804 | training_validation |
| 0.75 | 0.685 | 0.570 | 0.684 | 0.804 | estimated_from_training |
| 0.5:0.95 | 0.570 | 0.570 | 0.684 | 0.804 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 5.0):
- **mAP@0.5**: 0.780150 (training validation)
- **mAP@0.75**: 0.684576 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.570480 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.780, mAP@0.75=0.685, mAP@0.5:0.95=0.570
