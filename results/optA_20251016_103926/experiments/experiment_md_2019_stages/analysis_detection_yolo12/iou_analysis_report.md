...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.742 | 0.554 | 0.655 | 0.746 | training_validation |
| 0.75 | 0.665 | 0.554 | 0.655 | 0.746 | estimated_from_training |
| 0.5:0.95 | 0.554 | 0.554 | 0.655 | 0.746 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 27.0):
- **mAP@0.5**: 0.741820 (training validation)
- **mAP@0.75**: 0.664812 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.554010 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.742, mAP@0.75=0.665, mAP@0.5:0.95=0.554
