...
|---------------|-----|--------------|-----------|--------|--------|
| 0.5 | 0.695 | 0.468 | 0.685 | 0.627 | training_validation |
| 0.75 | 0.562 | 0.468 | 0.685 | 0.627 | estimated_from_training |
| 0.5:0.95 | 0.468 | 0.468 | 0.685 | 0.627 | training_validation |

## Analysis Results - TRAINING VALIDATION BASED

**PRE-COMPUTED METRICS** (from best training epoch 4.0):
- **mAP@0.5**: 0.694850 (training validation)
- **mAP@0.75**: 0.562032 (estimated from mAP50-95)
- **mAP@0.5:0.95**: 0.468360 (training validation)

**Performance Pattern**: Uses validation metrics from training
**Behavior**: No re-testing required, instant analysis

## Summary
- **Performance Range**: mAP@0.5=0.695, mAP@0.75=0.562, mAP@0.5:0.95=0.468
- **Best Epoch**: 4.0 out of 5 total epochs
