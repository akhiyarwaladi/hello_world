...
try:
    ...
    # Save results
    output_file = Path("experiments_organized_20250920_143119/yolo12_complete/04_analysis/iou_variation") / "iou_variation_results.json"
    ...
    csv_file = Path("experiments_organized_20250920_143119/yolo12_complete/04_analysis/iou_variation") / "iou_comparison_table.csv"
...
"""
    ...
    md_file = Path("experiments_organized_20250920_143119/yolo12_complete/04_analysis/iou_variation") / "iou_analysis_report.md"
    with open(md_file, 'w') as f:
        f.write(md_content)

    print(f"\n✅ IoU variation analysis completed!")
    print(f"📁 Results saved to: {Path('experiments_organized_20250920_143119/yolo12_complete/04_analysis/iou_variation')}")
