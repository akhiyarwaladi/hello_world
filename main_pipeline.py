    ...
    if args.dataset == "all":
        ...
        if len(all_dataset_names) > 1:
            ...
            try:
                ...
                print(f"   [PREPARE] Consolidated analysis path: {consolidated_path}")
                ...
                comprehensive_script = Path(__file__).parent / "scripts" / "analysis" / "generate_comprehensive_consolidated_analysis.py"
                ...
                if comprehensive_script.exists():
                    ...
                    print(f"   [INFO] You can run manually: python scripts/analysis/generate_comprehensive_consolidated_analysis.py {parent_manager.parent_folder}")
