...
Gambar 2A menampilkan hasil deteksi pada kasus malaria parah (gambar uji: 1704282807-0012-R_T) yang mengandung 25+ parasit P. falciparum dengan perkiraan tingkat parasitemia >10%. Perbandingan berdampingan menunjukkan anotasi acuan (panel kiri, kotak biru) versus deteksi prediksi YOLOv11 (panel kanan, kotak hijau), dimana semua 25+ parasit berhasil dideteksi dengan presisi lokalisasi tinggi (IoU >0,8), memvalidasi mAP@50 93,09% dan recall 92,26% YOLOv11. Keberhasilan deteksi pada kasus dengan kepadatan parasit sangat tinggi ini menunjukkan kemampuan model dalam menangani kondisi klinis berat dimana parasit saling berdekatan dan tumpang tindih, yang merupakan tantangan utama dalam sistem deteksi otomatis.
