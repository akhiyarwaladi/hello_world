...
Gambar menunjukkan konvergensi akurasi untuk semua model klasifikasi (DenseNet121 [6], EfficientNet B0/B1/B2 [7], ResNet50/101 [8]) selama 75 epoch pelatihan pada keempat dataset.
...
Gambar menunjukkan penurunan Focal Loss [9] untuk semua model selama pelatihan. Focal Loss dengan parameter alpha=0,25 dan gamma=2,0 berhasil menangani ketidakseimbangan kelas ekstrem [23] dengan memberikan penalty lebih besar pada easy examples dan fokus learning pada hard examples dari kelas minoritas.
